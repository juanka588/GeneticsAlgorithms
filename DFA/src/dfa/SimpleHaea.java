 ...
 * @author JuanCamilo
 */
public class SimpleHaea<G, P> implements Runnable {

    public SimpleHaea(int ThreadIdX, OptimizationFunction function, Vector<Solution<P>> pop, GrowingFunction<G, P> grow, int maxIter, Operator[] opers) {

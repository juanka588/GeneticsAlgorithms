...
import unalcol.optimization.operators.real.RealArityOne;
 ...
 * @author jgomez
 */
public class RandomCandidatesGenerationOverTime<T> implements PopulationGeneration<T> {

    /**
     * Set of genetic operators that are used by CEA for evolving the solution
     * chromosomes
     */
     ...
     */
    public RandomCandidatesGenerationOverTime(ArityOne<T> mutation) {
        this.mutation = mutation;
    }

    /**
     * Transforms the given population to another population according to its
     * rules.
     *

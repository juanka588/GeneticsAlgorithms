...
public interface FplConstants {
    ...
    public static final byte RIGHT_ARROW_1 = 22;
    public static final byte RIGHT_ARROW_2 = 23;
    public static final byte REWRITE = 24;
    public static final byte NATURAL_ANGLE = 25;
    ...
    public static final byte WITHOUT_TYPE = 40;
    public static final byte LIST = 41;
    public static final byte EOF = 42;
    public static final char LIST_FUNCTOR = '•';//©º∎
    public static final byte VAR_TERM = 60;
    public static final byte VAR_END = 61;
    public static final byte VAR_ENDF = 62;
    public static final byte VAR_SEPARATOR = 63;
    public static final byte VAR_ARGUMENT = 64;
    public static final byte VAR_PARAMETER = 65;
    public static final byte VAR_HEAD = 66;
    public static final byte VAR_TAIL = 67;
    public static final byte VAR_LIST = 68;
    ...
    public static final Color COLOR_CONSTANT = brown1;
